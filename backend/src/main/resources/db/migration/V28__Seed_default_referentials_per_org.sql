...
-- 2. V104__Seed_default_referentials_per_org.sql for production PostgreSQL
-- This file uses H2-compatible MERGE statements for idempotent seeding

-- Seed for a demo organization (DEMO-ORG)
-- Using MERGE to make it idempotent (works in both H2 and PostgreSQL)

-- CASE_TYPE referentials for DEMO-ORG
MERGE INTO referential (org_id, category, code, label, description, display_order, is_active, is_system, version)
KEY (org_id, category, code)
VALUES
