...
public class JacksonConfig {
    ...
    public ObjectMapper objectMapper(Jackson2ObjectMapperBuilder builder) {
        ...
        localDateTimeModule.addSerializer(
                LocalDateTime.class, new LocalDateTimeWithoutMillisSerializer());
    ...
    /**
     * Custom serializer for LocalDateTime that formats without milliseconds. This ensures
     * consistent timestamp format: 2024-01-15T10:30:00 instead of 2024-01-15T10:30:00.123456
     */
    private static class LocalDateTimeWithoutMillisSerializer
