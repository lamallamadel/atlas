...
public class FormatPreferencesDto {
    ...
    @Pattern(
        ...
        message = "Date format must be one of: dd/MM/yyyy, MM/dd/yyyy, yyyy-MM-dd, dd-MM-yyyy, dd.MM.yyyy"
    )
    ...
    @Pattern(
        ...
        message = "Number format must be one of: 1,234.56, 1.234,56, 1 234,56, 1234.56, 1234,56"
    )
    ...
    public FormatPreferencesDto(String dateFormat, String timeFormat, String currency, String numberFormat) {
