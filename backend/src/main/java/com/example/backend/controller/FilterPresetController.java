...
public class FilterPresetController {
    ...
    public ResponseEntity<FilterPresetResponse> create(@Valid @RequestBody FilterPresetRequest request) {
    ...
    @GetMapping("/{id}")
    @PreAuthorize("hasAnyRole('ADMIN', 'PRO')")
    @Operation(summary = "Get filter preset by ID", description = "Retrieves a filter preset by its ID")
    public ResponseEntity<FilterPresetResponse> getById(
            @Parameter(description = "ID of the filter preset", required = true)
    ...
    @GetMapping
    @PreAuthorize("hasAnyRole('ADMIN', 'PRO')")
    @Operation(summary = "List accessible filter presets", description = "Retrieves all accessible filter presets for a given type")
    public ResponseEntity<List<FilterPresetResponse>> list(
            @Parameter(description = "Filter type (e.g., DOSSIER, ANNONCE)")
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'PRO')")
    @Operation(summary = "List predefined filter presets", description = "Retrieves predefined filter presets for quick access")
    ...
    @GetMapping("/user")
    @PreAuthorize("hasAnyRole('ADMIN', 'PRO')")
    @Operation(summary = "List user's filter presets", description = "Retrieves filter presets created by the current user")
