...
public class EmailWebhookController {
    ...
    public ResponseEntity<Map<String, Object>> handleDeliveryCallback(
        ...
        try {
            EmailProviderConfig config = providerConfigRepository.findByOrgId(orgId)
                .orElse(null);
    ...
    private void processDeliveryEvent(String orgId, Map<String, Object> payload) {
        ...
        logger.info("Processing delivery event for orgId={}, messageId={}, status={}", 
    ...
    private void processBounceEvent(String orgId, Map<String, Object> payload) {
        ...
        logger.info("Processing bounce event for orgId={}, messageId={}, bounceType={}", 
            orgId, messageId, bounceType);
    }
    ...
    private void processComplaintEvent(String orgId, Map<String, Object> payload) {
        ...
        logger.info("Processing complaint event for orgId={}, messageId={}, complaintType={}", 
            orgId, messageId, complaintType);
    }
}
