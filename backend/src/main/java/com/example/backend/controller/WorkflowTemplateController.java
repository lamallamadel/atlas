...
@Tag(name = "Workflow Templates", description = "API for browsing and instantiating workflow templates")
public class WorkflowTemplateController {
    ...
    @Operation(summary = "List workflow templates", description = "Retrieves available workflow templates")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Instantiate template", description = "Creates a new workflow from a template")
    @ApiResponses(value = {
    ...
    public ResponseEntity<WorkflowDefinitionResponse> instantiateTemplate(
            ...
            @Parameter(description = "Custom name for the workflow")
            @RequestParam(required = false) String name) {
        WorkflowDefinitionResponse workflow = templateLibraryService.instantiateTemplate(templateId, name);
