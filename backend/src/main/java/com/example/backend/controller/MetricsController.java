...
public class MetricsController {
    ...
    /**
     * Résumé "admin" des métriques importantes.
     * - Counters (count)
     * - Timers (count, totalTimeMs, meanMs, maxMs)
     * - Gauges (value)
     *
     * Note: ce endpoint n'est pas un remplacement de /actuator/prometheus.
     */
    @GetMapping
    ...
    public ResponseEntity<Map<String, Object>> getMetricsSummary() {
        ...
        Set<String> allowPrefixes = Set.of(
            "dossier_", "annonce_", "appointments_", "notification_",
            "http.server.requests",
            "hikaricp", "jvm", "process", "system", "tomcat", "spring"
        );
        ...
        for (Meter m : meters) {
            ...
            if (m instanceof Counter c) {
                ...
                // Certains meters (DistributionSummary, LongTaskTimer, etc.) peuvent être ajoutés ici si besoin.
            }
        }
    ...
    /**
     * Highlights optionnels, pour avoir 2-3 points de contrôle rapide.
     * Ici : un état Hikari si présent (active/idle/total/pending).
     */
