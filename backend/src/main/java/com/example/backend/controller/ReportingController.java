...
public class ReportingController {
    ...
    public ReportingController(
            ReportingService reportingService, ObservabilityService observabilityService) {
    ...
    @Operation(
            ...
            description =
                    "Returns comprehensive KPI metrics including conversion rates, response times, appointment show rates, and pipeline velocity")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        ...
                        content =
                                @Content(
                                        schema =
                                                @Schema(implementation = KpiReportResponse.class))),
    ...
    public ResponseEntity<KpiReportResponse> getKpiReport(
        ...
        KpiReportResponse report =
                reportingService.generateKpiReport(fromDateTime, toDateTime, effectiveOrgId);
    ...
    @Operation(
            ...
            description =
                    "Returns summary of dossiers across all pipeline stages with counts and percentages")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Pipeline summary generated successfully",
                        content =
                                @Content(
                                        schema =
                                                @Schema(
                                                        implementation =
                                                                PipelineSummaryResponse.class)))
            })
    ...
    @Operation(
            ...
            description =
                    "Returns conversion funnel analysis with NEW→WON rates by source and stage-by-stage conversion metrics")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Funnel analysis generated successfully",
                        content =
                                @Content(
                                        schema =
                                                @Schema(
                                                        implementation =
                                                                FunnelAnalysisResponse.class))),
                @ApiResponse(responseCode = "400", description = "Invalid date parameters")
            })
    public ResponseEntity<FunnelAnalysisResponse> getFunnelAnalysis(
        ...
        FunnelAnalysisResponse analysis =
                reportingService.generateFunnelAnalysis(fromDateTime, toDateTime, effectiveOrgId);
    ...
    @Operation(
            ...
            description =
                    "Returns detailed agent performance metrics including response time, messages sent, appointments scheduled, and win rates")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Agent performance metrics generated successfully",
                        content =
                                @Content(
                                        schema =
                                                @Schema(
    ...
    public ResponseEntity<AgentPerformanceResponse> getAgentPerformance(
        ...
        AgentPerformanceResponse performance =
                reportingService.generateAgentPerformance(fromDateTime, toDateTime, effectiveOrgId);
    ...
    @Operation(
            ...
            description =
                    "Returns revenue forecast based on pipeline value and historical conversion rates, with breakdown by stage and source")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
    ...
    @Operation(
            summary = "Get revenue forecast with projections",
            description =
                    "Returns revenue forecast with 30/60/90 day projections including conservative, estimated, and optimistic scenarios")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Revenue forecast with projections generated successfully",
                        content =
                                @Content(
                                        schema =
                                                @Schema(
    ...
    public ResponseEntity<RevenueForecastResponse> getRevenueForecastWithProjections(
        ...
        RevenueForecastResponse forecast =
                reportingService.generateRevenueForecastWithProjections(effectiveOrgId);
        return ResponseEntity.ok(forecast);
    }

    @GetMapping("/funnel-analysis/by-source")
    @Operation(
            summary = "Get conversion funnel by source",
            description =
                    "Returns conversion funnel metrics broken down by lead source (WEBSITE, REFERRAL, PHONE, etc.)")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Conversion funnel by source generated successfully"),
                @ApiResponse(responseCode = "400", description = "Invalid date parameters")
            })
    public ResponseEntity<java.util.Map<String, FunnelAnalysisResponse.FunnelStageMetrics>>
            getConversionFunnelBySource(
                    @Parameter(description = "Start date (ISO format: yyyy-MM-dd)")
                            @RequestParam(required = false)
                            @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)
                            LocalDate from,
        ...
        java.util.Map<String, FunnelAnalysisResponse.FunnelStageMetrics> funnelBySource =
                reportingService.generateConversionFunnelBySource(
                        fromDateTime, toDateTime, effectiveOrgId);
        return ResponseEntity.ok(funnelBySource);
    }

    @GetMapping("/funnel-analysis/by-period")
    @Operation(
            summary = "Get conversion funnel by time period",
            description =
                    "Returns conversion funnel metrics broken down by time period (DAILY, WEEKLY, MONTHLY, QUARTERLY, YEARLY)")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Conversion funnel by period generated successfully"),
                @ApiResponse(
                        responseCode = "400",
                        description = "Invalid date or period type parameters")
            })
    public ResponseEntity<java.util.Map<String, FunnelAnalysisResponse.FunnelStageMetrics>>
            getConversionFunnelByPeriod(
                    @Parameter(description = "Start date (ISO format: yyyy-MM-dd)")
                            @RequestParam(required = false)
                            @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)
                            LocalDate from,
        ...
        java.util.Map<String, FunnelAnalysisResponse.FunnelStageMetrics> funnelByPeriod =
                reportingService.generateConversionFunnelByTimePeriod(
                        fromDateTime, toDateTime, effectiveOrgId, periodType);
    ...
    @Operation(
            ...
            description =
                    "Returns detailed performance metrics for a specific agent including response time, messages sent, appointments, and conversion rate")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Agent metrics generated successfully",
                        content =
                                @Content(
                                        schema =
                                                @Schema(
    ...
    public ResponseEntity<AgentPerformanceResponse.AgentMetrics> getDetailedAgentMetrics(
        ...
        AgentPerformanceResponse.AgentMetrics metrics =
                reportingService.generateDetailedAgentMetrics(
                        agentId, fromDateTime, toDateTime, effectiveOrgId);
    ...
    @Operation(
            ...
            description =
                    "Returns comprehensive analytics including agent performance, revenue forecast, lead sources, and conversion funnel")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Analytics data generated successfully"),
                @ApiResponse(responseCode = "400", description = "Invalid date parameters")
            })
    public ResponseEntity<java.util.Map<String, Object>> getAnalyticsData(
        ...
        java.util.Map<String, Object> analyticsData =
                reportingService.generateAnalyticsData(fromDateTime, toDateTime, effectiveOrgId);
    ...
    @Operation(
            ...
            description =
                    "Returns comprehensive observability metrics including queue depth, latency percentiles, failure rates, DLQ monitoring, and quota tracking")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Observability metrics generated successfully",
                        content =
                                @Content(
                                        schema =
                                                @Schema(
    ...
    public ResponseEntity<ObservabilityMetricsResponse> getObservabilityMetrics(
        ...
        ObservabilityMetricsResponse metrics =
                observabilityService.getObservabilityMetrics(
                        fromDateTime, toDateTime, effectiveOrgId);
        return ResponseEntity.ok(metrics);
    }
    ...
    @Operation(
            summary = "Export observability metrics",
            description = "Exports observability metrics in CSV or JSON format")
    @ApiResponses(
            value = {
    ...
    public ResponseEntity<String> exportObservabilityMetrics(
        ...
        if ("csv".equalsIgnoreCase(format)) {
            ...
            return ResponseEntity.ok()
                    ...
                    .header(
                            "Content-Disposition",
                            "attachment; filename=\"observability-metrics.csv\"")
                    .body(csv);
        } else {
            return ResponseEntity.ok()
                    ...
                    .header(
                            "Content-Disposition",
                            "attachment; filename=\"observability-metrics.json\"")
    ...
    private String convertMetricsToCsv(ObservabilityMetricsResponse metrics) {
                    ...
                    .forEach(
                            (channel, depth) ->
                                    csv.append("Queue,")
                                            ...
                                            .append(depth)
                                            .append("\n"));
            csv.append("Queue,Total,Total Queued,")
                    .append(metrics.getQueueMetrics().getTotalQueued())
                    .append("\n");
        }

        if (metrics.getLatencyMetrics() != null) {
            metrics.getLatencyMetrics()
                    .getLatencyByChannel()
                    .forEach(
                            (channel, percentiles) -> {
                                csv.append("Latency,")
                                        .append(channel)
                                        .append(",P50,")
                                        .append(percentiles.getP50())
                                        .append("\n");
                                csv.append("Latency,")
                                        .append(channel)
                                        .append(",P95,")
                                        .append(percentiles.getP95())
                                        .append("\n");
                                csv.append("Latency,")
                                        .append(channel)
                                        .append(",P99,")
                                        .append(percentiles.getP99())
                                        .append("\n");
                                csv.append("Latency,")
                                        .append(channel)
                                        .append(",Average,")
                                        .append(percentiles.getAverage())
                                        .append("\n");
                            });
        }
                    ...
                    .forEach(
                            (channel, count) ->
                                    csv.append("Failure,")
                                            ...
                                            .append(count)
                                            .append("\n"));
            csv.append("Failure,Overall,Failure Rate %,")
                    .append(metrics.getFailureMetrics().getOverallFailureRate())
                    .append("\n");

            metrics.getFailureMetrics()
                    .getFailuresByErrorCode()
                    .forEach(
                            (errorCode, count) ->
                                    csv.append("Failure,")
                                            .append(errorCode)
        ...
        if (metrics.getDlqMetrics() != null) {
            ...
            csv.append("DLQ,Alert,Threshold Exceeded,")
                    .append(metrics.getDlqMetrics().getAlertThresholdExceeded())
                    .append("\n");

            metrics.getDlqMetrics()
                    .getDlqSizeByChannel()
                    .forEach(
                            (channel, size) ->
                                    csv.append("DLQ,")
                    ...
                    .forEach(
                            (channel, usage) -> {
                                ...
                                csv.append("Quota,")
                                        .append(channel)
                                        .append(",Limit,")
                                        .append(usage.getLimit())
                                        .append("\n");
                                csv.append("Quota,")
                                        .append(channel)
                                        .append(",Usage %,")
                                        .append(usage.getUsagePercentage())
                                        .append("\n");
                            });
        }
    ...
    @Operation(
            ...
            description = "Generate a custom report based on selected dimensions and metrics")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
    ...
    @Operation(
            ...
            description = "Returns list of available report dimensions")
    ...
    @Operation(
            ...
            description = "Returns list of available report metrics")
