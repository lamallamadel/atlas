...
@Tag(
        name = "Calendar Sync",
        description = "API for calendar synchronization with external providers")
public class CalendarSyncController {
    ...
    @Operation(
            ...
            description = "Returns the OAuth URL for Google Calendar authorization")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
    ...
    public ResponseEntity<CalendarAuthUrlResponse> getGoogleAuthUrl() {
        ...
        response.setAuthUrl(
                "https://accounts.google.com/o/oauth2/v2/auth?client_id=example&redirect_uri=http://localhost:4200/calendar/callback&response_type=code&scope=https://www.googleapis.com/auth/calendar");
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'PRO')")
    @Operation(
            summary = "Get Outlook Calendar OAuth URL",
            description = "Returns the OAuth URL for Outlook Calendar authorization")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
    ...
    public ResponseEntity<CalendarAuthUrlResponse> getOutlookAuthUrl() {
        CalendarAuthUrlResponse response = new CalendarAuthUrlResponse();
        response.setAuthUrl(
                "https://login.microsoftonline.com/common/oauth2/v2.0/authorize?client_id=example&redirect_uri=http://localhost:4200/calendar/callback&response_type=code&scope=Calendars.ReadWrite");
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<Map<String, Boolean>> handleGoogleCallback(
            @RequestBody CalendarOAuthCallbackRequest request) {
    ...
    @Operation(
            ...
            description = "Processes the OAuth callback from Outlook")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
    ...
    public ResponseEntity<Map<String, Boolean>> handleOutlookCallback(
            @RequestBody CalendarOAuthCallbackRequest request) {
        Map<String, Boolean> response = new HashMap<>();
        response.put("success", true);
        return ResponseEntity.ok(response);
    ...
    @Operation(
            ...
            description = "Returns the synchronization status for all configured providers")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'PRO')")
    @Operation(
            summary = "Enable Google Calendar sync",
            description = "Enables automatic synchronization with Google Calendar")
    @ApiResponses(
            value = {
    ...
    public ResponseEntity<Map<String, Boolean>> enableGoogleSync(
            @RequestBody CalendarSyncConfigRequest config) {
        Map<String, Boolean> response = new HashMap<>();
        response.put("success", true);
        return ResponseEntity.ok(response);
    }
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'PRO')")
    @Operation(
            summary = "Enable Outlook Calendar sync",
            description = "Enables automatic synchronization with Outlook Calendar")
    @ApiResponses(
            value = {
                @ApiResponse(responseCode = "200", description = "Sync enabled successfully"),
                @ApiResponse(
    ...
    public ResponseEntity<Map<String, Boolean>> enableOutlookSync(
            @RequestBody CalendarSyncConfigRequest config) {
        Map<String, Boolean> response = new HashMap<>();
        response.put("success", true);
        return ResponseEntity.ok(response);
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'PRO')")
    @Operation(
            summary = "Disable Google Calendar sync",
            description = "Disables automatic synchronization with Google Calendar")
    @ApiResponses(
            value = {
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'PRO')")
    @Operation(
            summary = "Disable Outlook Calendar sync",
            description = "Disables automatic synchronization with Outlook Calendar")
    @ApiResponses(
            value = {
                @ApiResponse(responseCode = "200", description = "Sync disabled successfully")
            })
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'PRO')")
    @Operation(
            summary = "Trigger manual Google Calendar sync",
            description = "Triggers a manual synchronization with Google Calendar")
    @ApiResponses(
            value = {
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'PRO')")
    @Operation(
            summary = "Trigger manual Outlook Calendar sync",
            description = "Triggers a manual synchronization with Outlook Calendar")
    @ApiResponses(
            value = {
                @ApiResponse(responseCode = "200", description = "Sync completed successfully"),
                @ApiResponse(
    ...
    @Operation(
            ...
            description = "Returns a private iCal feed URL for calendar subscription")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Feed URL generated successfully",
                        content =
                                @Content(
                                        schema =
                                                @Schema(
                                                        implementation =
                                                                ICalFeedUrlResponse.class)))
            })
    public ResponseEntity<ICalFeedUrlResponse> getICalFeedUrl() {
        ICalFeedUrlResponse response = new ICalFeedUrlResponse();
        response.setFeedUrl(
                "http://localhost:8080/api/v1/calendar-sync/ical/feed/example-token-123");
    ...
    @Operation(
            ...
            description = "Regenerates the private token for iCal feed URL")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
