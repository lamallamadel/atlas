...
@Tag(
        ...
        description =
                "API for managing authenticated user preferences with category-based organization")
public class UserPreferencesController {
    ...
    @Operation(
            ...
            description =
                    "Retrieves all preferences for the authenticated user organized by categories (ui, notifications, formats, shortcuts) with inheritance from organization and system defaults")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
    ...
    @Operation(
            ...
            description =
                    "Updates user preferences for a specific category with JSON schema validation")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
    ...
    @Operation(
            ...
            description =
                    "Resets all user preferences to organization and system defaults, removing all user customizations")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "All preferences reset successfully"),
                @ApiResponse(responseCode = "401", description = "Unauthorized")
            })
    ...
    @PreAuthorize("hasAnyRole('USER', 'PRO', 'ADMIN')")
    @Operation(
            summary = "Get JSON schemas for validation",
            description =
                    "Returns JSON schema definitions for all preference categories to enable client-side validation")
    @ApiResponses(
            value = {
