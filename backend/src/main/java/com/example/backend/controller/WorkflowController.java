...
public class WorkflowController {
    ...
    @Operation(
            ...
            description = "Creates a new workflow definition (Admin only)")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "201",
    ...
    public ResponseEntity<WorkflowDefinitionResponse> getDefinitionById(
            @Parameter(description = "ID of the workflow definition", required = true) @PathVariable
                    Long id) {
    ...
    @Operation(
            ...
            description =
                    "Retrieves a paginated list of workflow definitions with optional filtering")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
    ...
    public ResponseEntity<Page<WorkflowDefinitionResponse>> listDefinitions(
            @Parameter(description = "Filter by case type") @RequestParam(required = false)
                    String caseType,
        ...
        Page<WorkflowDefinitionResponse> response =
                workflowService.listDefinitions(caseType, isActive, pageable);
    ...
    public ResponseEntity<List<WorkflowDefinitionResponse>> getTransitionsForCaseType(
            @Parameter(description = "Case type code", required = true) @PathVariable
                    String caseType) {
        List<WorkflowDefinitionResponse> response =
                workflowService.getTransitionsForCaseType(caseType);
    ...
    @Operation(
            ...
            description = "Publishes a workflow definition making it immutable")
    @ApiResponses(
            value = {
    ...
    @Operation(
            ...
            description = "Activates a published workflow for use")
    @ApiResponses(
            value = {
    ...
    @Operation(
            ...
            description = "Creates a new version of an existing workflow")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "201",
    ...
    public ResponseEntity<WorkflowDefinitionResponse> createNewVersion(
            @Parameter(description = "ID of the parent workflow", required = true) @PathVariable
                    Long id,
            @Parameter(description = "Version description") @RequestParam(required = false)
                    String description) {
    ...
    @Operation(
            ...
            description = "Updates an existing workflow definition (Admin only)")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
    ...
    @Operation(
            ...
            description = "Deletes a workflow definition (Admin only)")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "204",
    ...
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Transition history retrieved successfully",
                        content = @Content(schema = @Schema(implementation = Page.class)))
            })
    public ResponseEntity<Page<WorkflowTransitionResponse>> getTransitionHistory(
        ...
        Pageable pageable = createPageable(page, size, sort);
        Page<WorkflowTransitionResponse> response =
                workflowService.getTransitionHistory(dossierId, pageable);
        return ResponseEntity.ok(response);
    }
    ...
    @Operation(
            ...
            description =
                    "Retrieves allowed next statuses for a given case type and current status")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Allowed transitions retrieved successfully")
            })
    public ResponseEntity<List<String>> getAllowedNextStatuses(
            @Parameter(description = "Case type code", required = true) @RequestParam
                    String caseType,
            @Parameter(description = "Current status", required = true) @RequestParam
                    String currentStatus) {
        List<String> allowedStatuses =
                workflowValidationService.getAllowedNextStatuses(caseType, currentStatus);
    ...
    @Operation(
            ...
            description =
                    "Checks if a status transition would be valid without actually performing it. "
    ...
    public ResponseEntity<java.util.Map<String, Object>> validateTransition(
            @Parameter(description = "Dossier ID", required = true) @PathVariable Long dossierId,
            @Parameter(description = "Source status", required = true) @RequestParam
                    String fromStatus,
            @Parameter(description = "Target status", required = true) @RequestParam
                    String toStatus) {
        java.util.Map<String, Object> validationResult =
                workflowService.validateTransition(dossierId, fromStatus, toStatus);
