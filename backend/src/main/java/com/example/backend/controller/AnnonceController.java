...
public class AnnonceController {
    ...
    public AnnonceController(
            ...
            @Autowired(required = false) @Nullable
                    com.example.backend.service.YieldManagementService yieldManagementService) {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    @Operation(
            summary = "Trigger Yield Management",
            description =
                    "Manually triggers the yield management evaluation for all active annonces")
    @ApiResponses(
            value = {@ApiResponse(responseCode = "202", description = "Yield evaluation started")})
