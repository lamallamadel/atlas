...
public class ActivityController {
    ...
    @Operation(
            ...
            description = "Creates a new activity entry in the timeline")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "201",
    ...
    @Operation(
            ...
            description = "Retrieves a paginated list of activities with optional filtering")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
    ...
    public ResponseEntity<Page<ActivityResponse>> list(
        ...
        Page<ActivityResponse> response =
                activityService.list(dossierId, visibility, startDate, endDate, pageable);
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<ActivityResponse> update(
            @Parameter(description = "ID of the activity to update", required = true) @PathVariable
                    Long id,
