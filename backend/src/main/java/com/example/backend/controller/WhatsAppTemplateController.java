...
public class WhatsAppTemplateController {
    ...
    @Operation(
            ...
            description = "Returns all WhatsApp templates for the organization")
    ...
    @Operation(
            ...
            description = "Returns all active WhatsApp templates")
    ...
    @Operation(
            ...
            description = "Returns a single WhatsApp template by its ID")
    ...
    @PreAuthorize("hasRole('ADMIN')")
    @Operation(
            summary = "Get template by name and language",
            description = "Returns a template by its name and language code")
    ...
    public ResponseEntity<WhatsAppTemplateResponse> updateTemplate(
            @Parameter(description = "Template ID") @PathVariable Long id,
            @Parameter(description = "Updated template data") @Valid @RequestBody
                    WhatsAppTemplateRequest request) {
    ...
    @Operation(
            ...
            description = "Submits a template for WhatsApp Business API approval")
    ...
    @Operation(
            ...
            description = "Approves a template after WhatsApp Business API approval")
    public ResponseEntity<WhatsAppTemplateResponse> approveTemplate(
            @Parameter(description = "Template ID") @PathVariable Long id,
            @Parameter(description = "Approval data") @Valid @RequestBody
                    TemplateApprovalRequest request) {

        WhatsAppTemplate template =
                templateService.approveTemplate(id, request.getWhatsAppTemplateId());
        return ResponseEntity.ok(WhatsAppTemplateMapper.toResponse(template));
    }
    ...
    public ResponseEntity<WhatsAppTemplateResponse> rejectTemplate(
            @Parameter(description = "Template ID") @PathVariable Long id,
            @Parameter(description = "Rejection data") @Valid @RequestBody
                    TemplateRejectionRequest request) {

        WhatsAppTemplate template =
                templateService.rejectTemplate(id, request.getRejectionReason());
        return ResponseEntity.ok(WhatsAppTemplateMapper.toResponse(template));
    }
    ...
    @Operation(
            ...
            description = "Deletes a WhatsApp template (cannot delete active templates)")
