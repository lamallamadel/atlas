...
public class RateLimitController {
        ...
        @PreAuthorize("hasRole('ADMIN')")
        @Operation(summary = "Reset rate limit bucket for organization", description = "Clear the rate limit bucket for an organization, allowing immediate new requests")
        ...
        @PreAuthorize("hasRole('ADMIN')")
        @Operation(summary = "Reset rate limit bucket for IP address", description = "Clear the rate limit bucket for a specific IP address, allowing immediate new requests")
        ...
        @PreAuthorize("hasRole('ADMIN')")
        @Operation(summary = "Get rate limit statistics", description = "Retrieve comprehensive statistics about rate limiting including hits, rejections, and rates")
