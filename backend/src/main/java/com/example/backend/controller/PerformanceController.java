...
public class PerformanceController {
    ...
    @Operation(summary = "Audit database indexes", description = "Check for missing indexes on frequently used columns")
    public ResponseEntity<List<DatabaseIndexAudit.IndexRecommendation>> auditIndexes() {
        List<DatabaseIndexAudit.IndexRecommendation> recommendations = databaseIndexAudit.auditMissingIndexes();
