...
public class AnalyticsController {
    ...
    @Operation(
            summary = "Generate Metabase embed URL",
            description = "Generates a signed JWT URL for embedding Metabase dashboards")
    ...
    public ResponseEntity<MetabaseEmbedResponse> generateQuestionEmbedUrl(
            @PathVariable String questionId, @RequestBody Map<String, Object> params) {
        MetabaseEmbedResponse response =
                metabaseDashboardService.generateQuestionEmbedUrl(questionId, params, 10L);
        return ResponseEntity.ok(response);
    }
    ...
    @Operation(
            ...
            description = "Returns cohort conversion analysis by acquisition month")
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'PRO')")
    @Operation(
            summary = "Get funnel visualization",
            description = "Returns funnel visualization with drop-off rates")
    public ResponseEntity<AnalyticsResponse> getFunnelVisualization(
        ...
        AnalyticsResponse response =
                analyticsService.getFunnelVisualization(orgId, startDate, endDate);
        return ResponseEntity.ok(response);
    }
    ...
    @Operation(
            ...
            description = "Returns agent performance metrics and leaderboard")
    public ResponseEntity<AnalyticsResponse> getAgentPerformanceLeaderboard(
        ...
        String orgId = "default";
        AnalyticsResponse response =
                analyticsService.getAgentPerformanceLeaderboard(orgId, startDate, endDate);
        return ResponseEntity.ok(response);
    }
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'PRO')")
    @Operation(
            summary = "Get property market trends",
            description = "Returns market trends by location and property type")
    public ResponseEntity<AnalyticsResponse> getPropertyMarketTrends(
        ...
        String orgId = "default";
        AnalyticsResponse response =
                analyticsService.getPropertyMarketTrends(orgId, startDate, endDate);
        return ResponseEntity.ok(response);
    }
    ...
    @Operation(
            ...
            description = "Returns revenue forecast using historical patterns")
    public ResponseEntity<AnalyticsResponse> getRevenueForecast(
            @RequestParam(defaultValue = "6") int forecastMonths, Authentication authentication) {
        String orgId = "default";
