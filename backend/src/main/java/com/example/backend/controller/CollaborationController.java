...
public class CollaborationController {
    ...
    public void joinDossier(
            @DestinationVariable Long dossierId,
    ...
    public void shareFilterPreset(
            @Payload SharedFilterPresetDto filterPreset, Principal principal) {
    ...
    public static class CollaborationRestController {
        ...
        public Map<String, Object> getCurrentVersion(@PathVariable Long dossierId) {
            return Map.of(
                    ...
                    dossierId,
                    "version",
                    collaborationService.getCurrentVersion(dossierId));
        }

        @GetMapping("/user/{userId}/color")
        public Map<String, String> getUserColor(@PathVariable String userId) {
            return Map.of("userId", userId, "color", collaborationService.getUserColor(userId));
        }

        @PostMapping("/dossier/{dossierId}/conflict/resolve")
        public void resolveConflict(
                @PathVariable Long dossierId, @RequestBody Map<String, Object> conflictResolution) {
            ...
            collaborationService.broadcastConflictResolution(
                    dossierId, fieldName, resolvedValue, resolvedBy);
        }
    }
}
