...
@Tag(
        ...
        description = "API for managing organization-level tenant configuration")
public class OrganizationSettingsController {
    ...
    public ResponseEntity<OrganizationSettingsResponse> getCurrentSettings() {
        OrganizationSettingsResponse response =
                organizationSettingsService.getCurrentOrganizationSettings();
    ...
    @Operation(
            summary = "Get organization settings by org ID",
            description = "Retrieves settings for a specific organization (Admin only)")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
    ...
    @Operation(
            ...
            description = "Creates settings for a new organization (Admin only)")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "201",
                ...
                @ApiResponse(
                        responseCode = "400",
                        description = "Invalid request data or settings already exist"),
                @ApiResponse(
                        responseCode = "403",
                        description = "Access denied - Admin role required")
            })
    public ResponseEntity<OrganizationSettingsResponse> createSettings(
            @Parameter(description = "Organization ID", required = true) @PathVariable String orgId,
            @Valid @RequestBody OrganizationSettingsUpdateRequest request) {
        OrganizationSettingsResponse response =
                organizationSettingsService.createSettings(orgId, request);
    ...
    @Operation(
            ...
            description = "Updates settings for an organization (Admin only)")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
    ...
    public ResponseEntity<OrganizationSettingsResponse> updateSettings(
            ...
            @Valid @RequestBody OrganizationSettingsUpdateRequest request) {
        OrganizationSettingsResponse response =
                organizationSettingsService.updateSettings(orgId, request);
        return ResponseEntity.ok(response);
    }
    ...
    @Operation(
            ...
            description = "Deletes settings for an organization (Admin only)")
    @ApiResponses(
            value = {
    ...
    @Operation(
            ...
            description = "Retrieves branding settings for an organization")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
    ...
    @Operation(
            ...
            description = "Updates branding settings for an organization (Admin only)")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
    ...
    public ResponseEntity<OrganizationSettingsResponse> updateBranding(
        ...
        OrganizationSettingsResponse response =
                organizationSettingsService.updateBranding(orgId, branding);
        return ResponseEntity.ok(response);
    }
    ...
    @Operation(
            ...
            description = "Retrieves integration settings with decrypted credentials (Admin only)")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
    ...
    @Operation(
            ...
            description = "Updates integration settings and encrypts credentials (Admin only)")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
    ...
    public ResponseEntity<OrganizationSettingsResponse> updateIntegrations(
        ...
        OrganizationSettingsResponse response =
                organizationSettingsService.updateIntegrations(orgId, integrations);
        return ResponseEntity.ok(response);
    }
    ...
    @Operation(
            ...
            description = "Retrieves workflow settings for an organization")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
    ...
    @Operation(
            ...
            description = "Updates workflow settings for an organization (Admin only)")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
    ...
    public ResponseEntity<OrganizationSettingsResponse> updateWorkflow(
        ...
        OrganizationSettingsResponse response =
                organizationSettingsService.updateWorkflow(orgId, workflow);
        return ResponseEntity.ok(response);
    }
    ...
    @Operation(
            ...
            description = "Retrieves quota settings for an organization")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Quota settings retrieved successfully",
                        content =
                                @Content(
                                        schema = @Schema(implementation = QuotaSettingsDto.class))),
                @ApiResponse(responseCode = "404", description = "Organization settings not found")
            })
    ...
    @PreAuthorize("hasRole('ADMIN')")
    @Operation(
            summary = "Update quota settings",
            description = "Updates quota settings for an organization (Admin only)")
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Quota settings updated successfully",
                        content =
                                @Content(
                                        schema =
                                                @Schema(
    ...
    public ResponseEntity<OrganizationSettingsResponse> updateQuotas(
        ...
        OrganizationSettingsResponse response =
                organizationSettingsService.updateQuotas(orgId, quotas);
        return ResponseEntity.ok(response);
    }
}
