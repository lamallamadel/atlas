...
public class PartiePrenanteController {
    ...
    @Operation(summary = "Create a new partie prenante", description = "Creates a new partie prenante with the provided details")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Partie prenante created successfully",
                    content = @Content(schema = @Schema(implementation = PartiePrenanteResponse.class))),
            @ApiResponse(responseCode = "400", description = "Invalid request data",
                    content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
            @ApiResponse(responseCode = "404", description = "Dossier not found",
                    content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
    })
    public ResponseEntity<PartiePrenanteResponse> create(@Valid @RequestBody PartiePrenanteCreateRequest request) {
    ...
    @GetMapping("/{id:\\d+}")
    @PreAuthorize("hasAnyRole('ADMIN', 'PRO')")
    @Operation(summary = "Get partie prenante by ID", description = "Retrieves a single partie prenante by its ID")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Partie prenante found",
                    content = @Content(schema = @Schema(implementation = PartiePrenanteResponse.class))),
            @ApiResponse(responseCode = "404", description = "Partie prenante not found",
                    content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
    })
    ...
    @PutMapping("/{id:\\d+}")
    @PreAuthorize("hasAnyRole('ADMIN', 'PRO')")
    @Operation(summary = "Update partie prenante", description = "Updates an existing partie prenante with the provided details")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Partie prenante updated successfully",
                    content = @Content(schema = @Schema(implementation = PartiePrenanteResponse.class))),
            @ApiResponse(responseCode = "400", description = "Invalid request data",
                    content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
            @ApiResponse(responseCode = "404", description = "Partie prenante not found",
    ...
    @Operation(summary = "Delete partie prenante", description = "Deletes an existing partie prenante by its ID")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "Partie prenante deleted successfully"),
            @ApiResponse(responseCode = "404", description = "Partie prenante not found",
                    content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
    })
    ...
    @GetMapping
    @PreAuthorize("hasAnyRole('ADMIN', 'PRO')")
    @Operation(summary = "List parties prenantes by dossier", description = "Retrieves a list of parties prenantes for a given dossier")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Parties prenantes retrieved successfully",
                    content = @Content(schema = @Schema(implementation = PartiePrenanteResponse.class))),
            @ApiResponse(responseCode = "404", description = "Dossier not found",
                    content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
    })
