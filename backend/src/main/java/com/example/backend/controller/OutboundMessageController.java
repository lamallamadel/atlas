...
public class OutboundMessageController {
    ...
    public ResponseEntity<OutboundMessageResponse> createOutboundMessage(
        ...
        logger.info(
                "Creating outbound message: dossierId={}, channel={}, to={}, idempotencyKey={}",
    ...
    public ResponseEntity<List<OutboundMessageResponse>> listOutboundMessages(
        ...
        if (dossierId != null) {
            ...
            List<OutboundMessageResponse> responses =
                    messages.stream()
    ...
    public ResponseEntity<Page<OutboundMessageResponse>> listOutboundMessagesPaginated(
        ...
        logger.debug(
                "Listing outbound messages for dossier: {}, page={}, size={}",
                dossierId,
                page,
                size);
        ...
        Page<OutboundMessageEntity> messages =
                outboundMessageService.listByDossierPaginated(dossierId, pageable);
    ...
    public ResponseEntity<OutboundMessageResponse> retryOutboundMessage(@PathVariable Long id) {
        ...
        OutboundMessageEntity updated =
                outboundMessageService.updateStatus(id, OutboundMessageStatus.QUEUED, null, null);
