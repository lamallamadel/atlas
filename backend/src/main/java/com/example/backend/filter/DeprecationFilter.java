    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            ...
            if (handler != null && handler.getHandler() instanceof HandlerMethod) {
                ...
                Deprecated classDeprecation = AnnotationUtils.findAnnotation(handlerMethod.getBeanType(), Deprecated.class);
                ...
                if (deprecation != null) {
                    ...
                    response.addHeader("Link", "<https://docs.example.com/api-migration>; rel=\"deprecation\"; type=\"text/html\"");
