...
public interface MessageTemplateRepository extends JpaRepository<MessageTemplate, Long> {
    ...
    @Query("SELECT mt FROM MessageTemplate mt WHERE mt.isActive = true " +
           "AND (mt.orgId = :orgId OR mt.orgId = 'default') " +
           "AND mt.category = :category ORDER BY mt.usageCount DESC")
    List<MessageTemplate> findByCategoryOrderByUsage(@Param("orgId") String orgId, 
    ...
    List<MessageTemplate> findByChannelOrderByUsage(@Param("orgId") String orgId, 
