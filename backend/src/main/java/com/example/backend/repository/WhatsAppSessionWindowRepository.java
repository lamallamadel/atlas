...
@Repository
public interface WhatsAppSessionWindowRepository extends JpaRepository<WhatsAppSessionWindow, Long> {

    @Query("SELECT s FROM WhatsAppSessionWindow s WHERE s.orgId = :orgId AND s.phoneNumber = :phoneNumber")
