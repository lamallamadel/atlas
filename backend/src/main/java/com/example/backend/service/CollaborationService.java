...
public class CollaborationService {
    ...
    public void handleUserJoined(Long dossierId, String userId, String username) {
        ...
        CollaborationPresenceDto presence =
                new CollaborationPresenceDto(userId, username, dossierId, "joined");
    ...
    public void handleUserLeft(Long dossierId, String userId, String username) {
        ...
        CollaborationPresenceDto presence =
                new CollaborationPresenceDto(userId, username, dossierId, "left");
        messagingTemplate.convertAndSend("/topic/dossier/" + dossierId + "/presence", presence);
    ...
    public void broadcastCursor(
        ...
        CollaborationCursorDto cursor =
                new CollaborationCursorDto(
                        userId, username, dossierId, fieldName, cursorPosition, color);
        messagingTemplate.convertAndSend("/topic/dossier/" + dossierId + "/cursor", cursor);
    }

    public CollaborationEditDto broadcastEdit(
            Long dossierId,
            String userId,
            String username,
            String fieldName,
        ...
        CollaborationEditDto edit =
                new CollaborationEditDto(
                        userId, username, dossierId, fieldName, newValue, oldValue, newVersion);
    ...
    public void broadcastActivity(
            ...
            String description,
            Object data) {
        CollaborationActivityDto activity =
                new CollaborationActivityDto(
                        userId, username, dossierId, activityType, description, data);
        ...
        if (filterPreset.getSharedWithUserIds() != null) {
            for (String userId : filterPreset.getSharedWithUserIds()) {
                messagingTemplate.convertAndSendToUser(
                        userId, "/queue/filter-presets", filterPreset);
            }
        } else {
    ...
    public void broadcastConflictResolution(
            Long dossierId, String fieldName, Object resolvedValue, String resolvedBy) {
