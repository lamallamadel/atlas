...
public class DashboardKpiService {
    ...
    public DashboardKpiService(
            AnnonceRepository annonceRepository, DossierRepository dossierRepository) {
    ...
    public Map<String, TrendData> getTrends(String period) {
        ...
        try {
            ...
            log.error(
                    "Failed to calculate annoncesActives trend. correlationId={}, period={}",
                    correlationId,
                    period,
                    e);
        ...
        try {
            ...
            log.error(
                    "Failed to calculate dossiersATraiter trend. correlationId={}, period={}",
                    correlationId,
                    period,
                    e);
        ...
        log.info(
                "Successfully calculated trends with correlationId={}, period={}",
                correlationId,
                period);
        return trends;
    }
            ...
            if (startDate == null || previousStartDate == null) {
                ...
                Long current =
                        annonceRepository.countByStatusAndCreatedAtAfter(
                                AnnonceStatus.ACTIVE, orgId, startDate);
                currentCount = (current != null) ? current : 0L;

                Long previous =
                        annonceRepository.countByStatusAndCreatedAtBetween(
                                AnnonceStatus.ACTIVE, orgId, previousStartDate, startDate);
            ...
            if (startDate == null || previousStartDate == null) {
                ...
                Long current =
                        dossierRepository.countByStatusInAndCreatedAtAfter(
                                statusList, orgId, startDate);
                currentCount = (current != null) ? current : 0L;

                Long previous =
                        dossierRepository.countByStatusInAndCreatedAtBetween(
                                statusList, orgId, previousStartDate, startDate);
                previousCount = (previous != null) ? previous : 0L;
            }
        }
