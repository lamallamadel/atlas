...
public class DynamicThemeService {
    ...
    private Map<String, String> buildThemeFromConfig(WhiteLabelConfigEntity config) {
        ...
        theme.put(
                "--primary-color",
                config.getPrimaryColor() != null ? config.getPrimaryColor() : "#1976d2");
        theme.put(
                "--secondary-color",
                config.getSecondaryColor() != null ? config.getSecondaryColor() : "#424242");
        theme.put(
                "--accent-color",
                config.getAccentColor() != null ? config.getAccentColor() : "#ff4081");

        theme.put("--logo-url", config.getLogoUrl() != null ? config.getLogoUrl() : "");
        theme.put(
                "--logo-url-dark", config.getLogoUrlDark() != null ? config.getLogoUrlDark() : "");
