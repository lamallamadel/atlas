...
public class WorkflowTemplateLibraryService {
    ...
    public WorkflowDefinitionResponse instantiateTemplate(Long templateId, String customName) {
        ...
        if (!template.getIsTemplate()) {
            throw new IllegalArgumentException(
                    "Workflow with id " + templateId + " is not a template");
        }
        ...
        newWorkflow.setMetadataJson(
                template.getMetadataJson() != null
                        ? new HashMap<>(template.getMetadataJson())
                        : null);
    ...
    private void seedSaleTemplate() {
        ...
        transitions.add(
                createTransition(
                        ...
                        "QUALIFIED",
                        "Qualify Lead",
                        Arrays.asList("leadEmail", "budget")));
        transitions.add(
                createTransition(
                        "QUALIFIED", "PROPOSAL", "Send Proposal", Arrays.asList("propertyId")));
        transitions.add(
                createTransition("PROPOSAL", "WON", "Close Deal", Arrays.asList("wonReason")));
        transitions.add(
                createTransition("PROPOSAL", "LOST", "Mark as Lost", Arrays.asList("lossReason")));
        transitions.add(
    ...
    private void seedRentalTemplate() {
        ...
        states.add(
                createState("VIEWING", "Viewing Scheduled", "intermediate", "#F59E0B", 300, 100));
        states.add(
                createState(
                        "APPLICATION",
                        ...
                        100));
        states.add(
                createState("SCREENING", "Tenant Screening", "intermediate", "#10B981", 700, 100));
        ...
        transitions.add(
                createTransition(
                        ...
                        "APPLICATION",
                        "Receive Application",
                        Arrays.asList("leadEmail")));
        transitions.add(
                createTransition(
                        "APPLICATION", "SCREENING", "Start Screening", Collections.emptyList()));
        transitions.add(
                createTransition(
                        "SCREENING", "RENTED", "Approve & Rent", Arrays.asList("wonReason")));
        transitions.add(
                createTransition(
                        "SCREENING", "LOST", "Reject Application", Arrays.asList("lossReason")));
        transitions.add(
                createTransition("VIEWING", "LOST", "No Follow-up", Arrays.asList("lossReason")));
    ...
    private void seedMandateTemplate() {
        ...
        states.add(
                createState(
                        "EVALUATION", "Property Evaluation", "intermediate", "#8B5CF6", 500, 100));
        states.add(
                createState("PROPOSAL", "Mandate Proposal", "intermediate", "#10B981", 700, 100));
        ...
        transitions.add(
                createTransition(
                        ...
                        "EVALUATION",
                        "Schedule Evaluation",
                        Arrays.asList("propertyAddress")));
        transitions.add(
                createTransition(
                        "EVALUATION",
                        "PROPOSAL",
                        "Send Proposal",
                        Arrays.asList("estimatedValue")));
        transitions.add(
                createTransition(
                        "PROPOSAL",
                        "SIGNED",
                        "Sign Mandate",
                        Arrays.asList("wonReason", "mandateDate")));
        transitions.add(
                createTransition(
                        "PROPOSAL", "LOST", "Proposal Rejected", Arrays.asList("lossReason")));
        transitions.add(
                createTransition("CONTACT", "LOST", "No Interest", Arrays.asList("lossReason")));
    ...
    private void seedConstructionTemplate() {
        ...
        states.add(
                createState("PERMITS", "Permits & Approvals", "intermediate", "#8B5CF6", 500, 100));
        states.add(
                createState(
                        "CONSTRUCTION", "Under Construction", "intermediate", "#10B981", 700, 100));
        states.add(
                createState("INSPECTION", "Final Inspection", "intermediate", "#06B6D4", 900, 100));
        ...
        transitions.add(
                createTransition(
                        ...
                        "PLANNING",
                        "Start Planning",
                        Arrays.asList("clientName", "projectType")));
        transitions.add(
                createTransition(
                        "PLANNING", "PERMITS", "Submit for Permits", Arrays.asList("blueprints")));
        transitions.add(
                createTransition(
                        "PERMITS",
                        "CONSTRUCTION",
                        "Start Construction",
                        Arrays.asList("permitApproval")));
        transitions.add(
                createTransition(
                        "CONSTRUCTION",
                        "INSPECTION",
        ...
        transitions.add(
                createTransition(
                        ...
                        "COMPLETED",
                        "Complete Project",
                        Arrays.asList("completionDate")));
        transitions.add(
                createTransition(
                        "PLANNING", "CANCELLED", "Cancel Project", Arrays.asList("lossReason")));
        transitions.add(
                createTransition(
                        "PERMITS", "CANCELLED", "Cancel Project", Arrays.asList("lossReason")));
    ...
    private WorkflowTemplateResponse toTemplateResponse(WorkflowDefinition template) {
        ...
        response.setStateCount(
                template.getStatesJson() != null ? template.getStatesJson().size() : 0);
        response.setTransitionCount(
                template.getTransitionsJson() != null ? template.getTransitionsJson().size() : 0);
        return response;
    }
}
