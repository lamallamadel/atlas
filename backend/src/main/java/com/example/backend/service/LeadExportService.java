...
public class LeadExportService {
    ...
    public void exportLeads(Writer writer, DossierStatus status, LocalDateTime startDate, 
                           LocalDateTime endDate, DossierSource source, List<String> columns) throws IOException {
    ...
    private Specification<Dossier> buildSpecification(String orgId, DossierStatus status, 
    ...
    private List<String> getDefaultColumns() {
        return Arrays.asList("id", "name", "phone", "email", "source", "lead_source", 
        ...
        for (String column : columns) {
            ...
            switch (column.toLowerCase()) {
                ...
                case "notes":
                    ...
                    break;
                case "created_at":
                    value = dossier.getCreatedAt() != null ? dossier.getCreatedAt().format(DATE_FORMATTER) : "";
                    break;
                case "updated_at":
                    value = dossier.getUpdatedAt() != null ? dossier.getUpdatedAt().format(DATE_FORMATTER) : "";
                    break;
                case "created_by":
