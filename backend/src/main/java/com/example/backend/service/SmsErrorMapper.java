...
public class SmsErrorMapper {
    ...
    static {
        ...
        ERROR_CODE_MAP.put(
                "TWILIO_21211", new ErrorInfo("Invalid 'To' phone number", false, false));
        ERROR_CODE_MAP.put(
                "TWILIO_21408",
                new ErrorInfo("Permission to send to unverified number", false, false));
        ERROR_CODE_MAP.put(
                "TWILIO_21601",
                new ErrorInfo("Phone number not capable of receiving SMS", false, false));
        ERROR_CODE_MAP.put(
                "TWILIO_21610", new ErrorInfo("Message cannot be sent to landline", false, false));
        ERROR_CODE_MAP.put(
                "TWILIO_21612", new ErrorInfo("Unable to reach destination", true, false));
        ...
        ERROR_CODE_MAP.put(
                "TWILIO_30003", new ErrorInfo("Unreachable destination handset", true, false));
        ERROR_CODE_MAP.put(
                "TWILIO_30004", new ErrorInfo("Message blocked by carrier", false, false));
        ERROR_CODE_MAP.put(
                "TWILIO_30005", new ErrorInfo("Unknown destination handset", false, false));
        ERROR_CODE_MAP.put(
                "TWILIO_30006", new ErrorInfo("Landline or unreachable carrier", false, false));
        ERROR_CODE_MAP.put(
                "TWILIO_30007", new ErrorInfo("Carrier violation or spam", false, false));
        ...
        ERROR_CODE_MAP.put(
                "AWS_INVALID_PARAMETER", new ErrorInfo("Invalid parameter value", false, false));
        ERROR_CODE_MAP.put(
                "AWS_INTERNAL_ERROR", new ErrorInfo("Internal AWS service error", true, false));
        ...
        ERROR_CODE_MAP.put(
                "INVALID_PHONE", new ErrorInfo("Invalid phone number format", false, false));
        ERROR_CODE_MAP.put(
                "MESSAGE_TOO_LONG", new ErrorInfo("Message exceeds length limit", false, false));
        ...
        ERROR_CODE_MAP.put(
                "INSUFFICIENT_FUNDS", new ErrorInfo("Insufficient account balance", false, false));
        ERROR_CODE_MAP.put(
                "NETWORK_ERROR", new ErrorInfo("Network communication error", true, false));
