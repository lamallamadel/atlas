...
public class SeedDataLoader implements CommandLineRunner {
        ...
        private List<ReferentialEntity> createReferentialsForOrg(String orgId) {
                ...
                referentials.add(
                                createReferential(
                                                orgId, "CASE_STATUS", "CRM_NO_SHOW", "Absent", "No show", order++,
                                                true));
                referentials.add(
                                createReferential(
                                                orgId,
                ...
                referentials.add(
                                createReferential(
                                                orgId, "LEAD_SOURCE", "EMAIL", "Email", "Lead from email", order++,
                                                true));
                referentials.add(
                                createReferential(
                                                orgId,
                ...
                referentials.add(
                                createReferential(
                                                orgId, "LEAD_SOURCE", "AVITO", "Avito", "Lead from Avito", order++,
                                                true));
                referentials.add(
                                createReferential(
                                                orgId,
        ...
        private void loadDossiers() {
                ...
                List<Annonce> org001Annonces = allAnnonces.stream().filter(a -> ORG_001.equals(a.getOrgId())).toList();

                List<Annonce> org002Annonces = allAnnonces.stream().filter(a -> ORG_002.equals(a.getOrgId())).toList();
        ...
        private void loadPartiesPrenantes(List<Dossier> dossiers) {
                ...
                // Get dossiers by org
                List<Dossier> org001Dossiers = dossiers.stream().filter(d -> ORG_001.equals(d.getOrgId())).toList();

                List<Dossier> org002Dossiers = dossiers.stream().filter(d -> ORG_002.equals(d.getOrgId())).toList();
