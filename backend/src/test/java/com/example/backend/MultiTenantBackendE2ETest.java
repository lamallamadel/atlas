...
public class MultiTenantBackendE2ETest extends BaseBackendE2ETest {
    ...
    public void testCreateIdenticalEntitiesInDifferentOrgs() throws Exception {
        ...
        DossierResponse response1 = objectMapper.readValue(
        ...
        DossierResponse response2 = objectMapper.readValue(
    ...
    public void testGetWithWrongOrgIdReturns404() throws Exception {
        ...
        DossierResponse created = objectMapper.readValue(
    ...
    public void testRepositoryWhereClauseFiltering() throws Exception {
        ...
        try {
            ...
            assertThat(org001Dossiers).extracting(Dossier::getOrgId)
                    .containsOnly(ORG_001);
            assertThat(org001Dossiers).extracting(Dossier::getLeadName)
        ...
        try {
            ...
            assertThat(org002Dossiers).extracting(Dossier::getOrgId)
                    .containsOnly(ORG_002);
            assertThat(org002Dossiers).extracting(Dossier::getLeadName)
    ...
    public void testAuditEventsScopedToCorrectOrgId() throws Exception {
        ...
        List<AuditEventEntity> org001Audits = allAudits.stream()
                .filter(audit -> ORG_001.equals(audit.getOrgId()))
                .toList();
        ...
        List<AuditEventEntity> org002Audits = allAudits.stream()
                .filter(audit -> ORG_002.equals(audit.getOrgId()))
                .toList();
