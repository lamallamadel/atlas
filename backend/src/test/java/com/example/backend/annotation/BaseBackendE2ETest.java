...
public abstract class BaseBackendE2ETest {
    ...
    protected HttpHeaders buildHeadersWithAuth(
            String tenantId, String correlationId, String bearerToken) {
    ...
    protected void assertProblemDetail(
            ResultActions resultActions, int expectedStatus, String expectedDetail)
            throws Exception {
        resultActions
    ...
    protected void assertProblemDetailContains(
            ResultActions resultActions, int expectedStatus, String detailSubstring)
            throws Exception {
        resultActions
                .andExpect(status().is(expectedStatus))
                .andExpect(jsonPath("$.status").value(expectedStatus))
    ...
    protected void assertProblemDetail(ResultActions resultActions, int expectedStatus)
            throws Exception {
        resultActions
                .andExpect(status().is(expectedStatus))
                .andExpect(jsonPath("$.status").value(expectedStatus))
