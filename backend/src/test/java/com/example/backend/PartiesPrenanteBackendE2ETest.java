...
class PartiesPrenanteBackendE2ETest extends BaseBackendE2ETest {
    ...
    void postCreate_WithValidRole_Returns201AndAuditEvent() throws Exception {
        ...
        String responseContent = mockMvc.perform(withTenantHeaders(
                        post(BASE_URL)
    ...
    void getById_ExistingEntity_Returns200() throws Exception {
        Dossier dossier = createDossier(TENANT_ID);
        PartiePrenanteEntity entity = createPartiePrenanteEntity(dossier, TENANT_ID, PartiePrenanteRole.BUYER);
    ...
    void getById_NonExistingEntity_Returns404() throws Exception {
        mockMvc.perform(withTenantHeaders(
                        get(BASE_URL + "/99999"), TENANT_ID, CORRELATION_ID))
    ...
    void getById_CrossTenantIsolation_Returns404() throws Exception {
        ...
        PartiePrenanteEntity entity = createPartiePrenanteEntity(dossier, OTHER_TENANT_ID, PartiePrenanteRole.SELLER);
    ...
    void deleteById_AsAdmin_Returns204AndAuditEvent() throws Exception {
        Dossier dossier = createDossier(TENANT_ID);
        PartiePrenanteEntity entity = createPartiePrenanteEntity(dossier, TENANT_ID, PartiePrenanteRole.NOTARY);
        auditEventRepository.deleteAll();
    ...
    void deleteById_CrossTenantIsolation_Returns404() throws Exception {
        Dossier dossier = createDossier(OTHER_TENANT_ID);
        PartiePrenanteEntity entity = createPartiePrenanteEntity(dossier, OTHER_TENANT_ID, PartiePrenanteRole.AGENT);
    ...
    void getListByDossier_WithPagination_ReturnsFilteredResults() throws Exception {
        ...
        mockMvc.perform(withTenantHeaders(
                        get(BASE_URL)
                                .param("dossierId", dossier1.getId().toString()), TENANT_ID, CORRELATION_ID))
                .andExpect(status().isOk())
    ...
    void getListByDossier_CrossTenantDossier_Returns404() throws Exception {
        ...
        mockMvc.perform(withTenantHeaders(
                        get(BASE_URL)
                                .param("dossierId", dossier.getId().toString()), TENANT_ID, CORRELATION_ID))
                .andExpect(status().isNotFound());
    }
    ...
    void postCreate_AllValidRoles_Returns201() throws Exception {
        ...
        String[] validRoles = {"OWNER", "BUYER", "SELLER", "TENANT", "LANDLORD", "AGENT", "NOTARY", "BANK", "ATTORNEY"};
    ...
    void postCreate_WithValidPhoneFormats_Returns201() throws Exception {
        ...
        String[] validPhones = {"+33612345678", "0612345678", "+1 (555) 123-4567", "+44 20 1234 5678"};
    ...
    void completeWorkflow_CreateUpdateDelete_CreatesFullAuditTrail() throws Exception {
        ...
        String createResponse = mockMvc.perform(withTenantHeaders(
                        post(BASE_URL)
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(objectMapper.writeValueAsString(createRequest)), TENANT_ID, CORRELATION_ID))
                .andExpect(status().isCreated())
                .andReturn().getResponse().getContentAsString();
        ...
        mockMvc.perform(withTenantHeaders(
                        put(BASE_URL + "/" + entityId)
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(objectMapper.writeValueAsString(updateRequest)), TENANT_ID, CORRELATION_ID))
                .andExpect(status().isOk());
        ...
        @SuppressWarnings("unchecked")
        Map<String, Object> updateChanges = (Map<String, Object>) updateEvent.getDiff().get("changes");
    ...
    void postCreate_WithMetadata_Returns201AndAuditEventWithMeta() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        Map<String, Object> afterData = (Map<String, Object>) auditEvents.get(0).getDiff().get("after");
    ...
    void putUpdate_CrossTenantEntity_Returns404() throws Exception {
        Dossier dossier = createDossier(OTHER_TENANT_ID);
        PartiePrenanteEntity entity = createPartiePrenanteEntity(dossier, OTHER_TENANT_ID, PartiePrenanteRole.BUYER);
    ...
    void getListByDossier_NonExistingDossier_Returns404() throws Exception {
        mockMvc.perform(withTenantHeaders(
                        get(BASE_URL)
                                .param("dossierId", "99999"), TENANT_ID, CORRELATION_ID))
                .andExpect(status().isNotFound());
    }
    ...
    private PartiePrenanteEntity createPartiePrenanteEntity(Dossier dossier, String orgId, PartiePrenanteRole role) {
