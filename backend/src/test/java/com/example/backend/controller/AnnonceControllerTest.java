...
class AnnonceControllerTest {
    ...
    void getById_NonExistingId_Returns404() throws Exception {
        ...
        when(annonceService.getById(nonExistingId)).thenThrow(new EntityNotFoundException("Annonce not found"));
    ...
    void update_ValidRequest_Returns200() throws Exception {
        ...
        when(annonceService.update(eq(testAnnonceId), any(AnnonceUpdateRequest.class))).thenReturn(updatedResponse);

        mockMvc.perform(withHeaders(put("/api/v1/annonces/" + testAnnonceId)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    void update_NonExistingId_Returns404() throws Exception {
        ...
        mockMvc.perform(withHeaders(put("/api/v1/annonces/" + nonExistingId)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(updateRequest))))
            .andExpect(status().isNotFound());
    ...
    void list_NoFilters_Returns200WithPagedResults() throws Exception {
        ...
        Page<AnnonceResponse> page = new PageImpl<>(Arrays.asList(response1, response2), PageRequest.of(0, 20), 2);
        
        when(annonceService.list(isNull(), isNull(), isNull(), isNull(), any(Pageable.class))).thenReturn(page);
    ...
    void list_WithStatusFilter_Returns200WithFilteredResults() throws Exception {
        ...
        AnnonceResponse response = createMockResponse(1L, "Published Annonce", AnnonceStatus.PUBLISHED);
        Page<AnnonceResponse> page = new PageImpl<>(Collections.singletonList(response), PageRequest.of(0, 20), 1);
        
        when(annonceService.list(eq(AnnonceStatus.PUBLISHED), isNull(), isNull(), isNull(), any(Pageable.class))).thenReturn(page);
        ...
        verify(annonceService, times(1)).list(eq(AnnonceStatus.PUBLISHED), isNull(), isNull(), isNull(), any(Pageable.class));
    }
    ...
    void list_WithSearchQuery_Returns200WithMatchingResults() throws Exception {
        ...
        AnnonceResponse response = createMockResponse(1L, "Electronics in Paris", AnnonceStatus.PUBLISHED);
        Page<AnnonceResponse> page = new PageImpl<>(Collections.singletonList(response), PageRequest.of(0, 20), 1);
        
        when(annonceService.list(isNull(), eq("Electronics"), isNull(), isNull(), any(Pageable.class))).thenReturn(page);
        ...
        verify(annonceService, times(1)).list(isNull(), eq("Electronics"), isNull(), isNull(), any(Pageable.class));
    }
    ...
    void list_WithStatusAndSearchQuery_Returns200WithFilteredAndMatchingResults() throws Exception {
        ...
        when(annonceService.list(eq(AnnonceStatus.PUBLISHED), eq("Electronics"), isNull(), isNull(), any(Pageable.class))).thenReturn(page);
        ...
        verify(annonceService, times(1)).list(eq(AnnonceStatus.PUBLISHED), eq("Electronics"), isNull(), isNull(), any(Pageable.class));
    }
    ...
    void list_WithPagination_Returns200WithCorrectPage() throws Exception {
        ...
        List<AnnonceResponse> responses = Arrays.asList(
    ...
    void list_WithSorting_Returns200WithSortedResults() throws Exception {
        ...
        Page<AnnonceResponse> page = new PageImpl<>(Arrays.asList(responseA, responseB), PageRequest.of(0, 20), 2);
    ...
    void list_EmptyResult_Returns200WithEmptyPage() throws Exception {
        ...
        Page<AnnonceResponse> emptyPage = new PageImpl<>(Collections.emptyList(), PageRequest.of(0, 20), 0);
        
        when(annonceService.list(isNull(), isNull(), isNull(), isNull(), any(Pageable.class))).thenReturn(emptyPage);
