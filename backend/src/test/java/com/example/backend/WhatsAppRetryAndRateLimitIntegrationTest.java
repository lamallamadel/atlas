...
class WhatsAppRetryAndRateLimitIntegrationTest extends BaseBackendE2ETest {
    ...
    @Autowired private WhatsAppSessionWindowService sessionWindowService;
    ...
    void testRetry_FirstAttemptSuccess() {
        ...
        when(mockWhatsAppProvider.send(any()))
                .thenReturn(ProviderSendResult.success("wamid.success123", null));
    ...
    @org.junit.jupiter.api.Disabled(
            "Requires Redis; skipped in E2E H2 profile where Redis is not available")
    ...
    void testSessionWindow_WithinWindow() {
        ...
        Optional<LocalDateTime> expiry =
                sessionWindowService.getSessionWindowExpiry(TENANT_1, TEST_PHONE);
    ...
    void testSessionWindow_InboundUpdatesWindow() {
        ...
        WhatsAppSessionWindow updated =
                sessionWindowRepository
                        .findByOrgIdAndPhoneNumber(TENANT_1, TEST_PHONE)
                        .orElseThrow();
        assertThat(updated.getLastInboundMessageAt())
                .isAfterOrEqualTo(newInboundTime.minusSeconds(1));
    ...
    void testSessionWindow_OutboundRecorded() {
        ...
        WhatsAppSessionWindow after =
                sessionWindowRepository
                        .findByOrgIdAndPhoneNumber(TENANT_1, TEST_PHONE)
                        .orElseThrow();
        assertThat(after.getLastOutboundMessageAt()).isNotNull();
        assertThat(after.getLastOutboundMessageAt())
    ...
    void testExponentialBackoff_VerifyPattern() {
        ...
        for (int i = 0; i < expectedBackoffs.length - 1; i++) {
            ...
            assertThat(lastAttempt.getNextRetryAt())
                    .withFailMessage(
                            "Attempt %d should have %d minute backoff", i + 1, expectedBackoffs[i])
                    .isAfterOrEqualTo(expectedRetry.minusSeconds(5))
                    .isBeforeOrEqualTo(expectedRetry.plusSeconds(5));
